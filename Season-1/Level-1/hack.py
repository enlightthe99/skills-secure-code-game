...
class TestOnlineStore(unittest.TestCase):
    ...
    def test_6(self):
        ...
        payment = c.Item(type='payment', description='invoice_4', amount=1000.00, quantity=1)
    ...
    def test_7(self):
        small_item = c.Item(type='product', description='accessory', amount=3.3, quantity=3)
        payment_1 = c.Item(type='payment', description='invoice_5_1', amount=1.1, quantity=1)
        payment_2 = c.Item(type='payment', description='invoice_5_2', amount=2.2, quantity=2)
